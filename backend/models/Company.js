...
const companySchema = new mongoose.Schema({
    ...
    status: {
        type: String,
        enum: ['active', 'inactive', 'pending', 'approved', 'rejected', 'Active', 'Inactive', 'Pending', 'Approved', 'Rejected'],
        default: 'active',
    },
    isActive: {
        type: Boolean,
