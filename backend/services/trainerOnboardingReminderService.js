...
const runTrainerOnboardingReminders = async () => {
  ...
  try {
    const trainers = await Trainer.find({
      ...
      "_id userId email firstName lastName mobile phone city cityId qualification specialization experience address documents agreementAccepted agreementAccepted signature passwordHash registrationStatus registrationStep status verificationStatus registrationReminderState",
    );
