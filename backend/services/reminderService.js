        ...
        for (const schedule of schedules) {
            try {
                ...
                await sendNotification(null, {
                    ...
                    message: `Reminder: You have a training for ${course?.title || 'TEST COURSE'} at ${college?.name} tomorrow, ${formattedDate} (${formattedTime}). Contact SPOC: ${spocName} (${spocPhone})`,
                    type: 'Schedule',
