      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {days.map((day) => {
          ...
          const statusStyles = {
            ...
            "Absent / No Check-In": "bg-rose-50 text-rose-700 border-rose-200",
            Absent: "bg-rose-50 text-rose-700 border-rose-200",
            "Not Assigned": "bg-slate-50 text-slate-600 border-slate-200",
          };
            ...
            >
              <div className="flex-1">
                ...
                <div className="flex justify-between items-center mb-5">
                  ...
                  >
                    {status === 'Completed' ? '🟢 ' : (status === 'Absent' || status === 'Absent / No Check-In') ? '🔴 ' : status === 'Pending' ? '🟠 ' : '🔵 ' }
                    {status}
                  </span>
                </div>
