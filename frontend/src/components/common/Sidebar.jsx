...
const Sidebar = () => {
    ...
    const navigation = [
        ...
        { name: 'Schedule', href: '/trainer/schedule', icon: Calendar, roles: ['Trainer'] },
        { name: 'My Attendance', href: '/trainer/attendance', icon: ClipboardDocumentCheckIcon, roles: ['Trainer'] },
        { name: 'Payslips', href: '/trainer/payslips', icon: CurrencyRupeeIcon, roles: ['Trainer'] },
        { name: 'Complaints', href: '/trainer/complaints', icon: ChatBubbleLeftRightIcon, roles: ['Trainer'] },
        { name: 'Profile Settings', href: '/trainer/settings', icon: Cog6ToothIcon, roles: ['Trainer'] },
    ];
