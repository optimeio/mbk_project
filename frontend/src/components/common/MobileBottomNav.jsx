...
const NAV_MAP = {
  ...
  Trainer: [
    ...
    { name: "Attendance", href: "/trainer/attendance", icon: BadgeCheck },
    { name: "Payslips", href: "/trainer/payslips", icon: Receipt },
    { name: "More", href: "/trainer/settings", icon: MoreHorizontal },
  ],
  Student: [
  ...
  Company: [
    ...
    { name: "Trainers", href: "/company/trainers", icon: Users },
