...
import '@/components/common/Orb.css';
...
const frag = /* glsl */ `
  ...
  const vec3 baseColor1 = vec3(0.06, 0.21, 0.34);
  const vec3 baseColor2 = vec3(0.18, 0.55, 0.75);
  const vec3 baseColor3 = vec3(0.02, 0.08, 0.20);
