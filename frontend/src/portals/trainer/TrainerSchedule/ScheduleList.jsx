                    ...
                    {schedule.ui.primaryAction?.kind === "checkin" ? (
                      ...
                      <div className="flex flex-col gap-1">
                        <span className="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-semibold bg-indigo-50 text-indigo-800 border border-indigo-200 shadow-sm">
                          ...
                          Late Attendance Requested (Pending Approval)
                        </span>
                      ...
                      <div className="flex flex-col items-end gap-1.5">
                        <span className="text-xs text-red-500 font-medium italic bg-red-50 px-2 py-0.5 rounded border border-red-100">
                          {schedule.ui.primaryAction.label}
                        </span>
                        <button
                          onClick={() => onOpenLateRequest && onOpenLateRequest(schedule)}
                          className="inline-flex items-center px-3 py-1 border border-indigo-600 text-xs font-semibold rounded-lg text-indigo-600 bg-white hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 shadow-sm"
                        >
