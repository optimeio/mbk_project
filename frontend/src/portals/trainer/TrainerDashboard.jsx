        ...
        <div className="mx-auto flex max-w-4xl flex-col items-center justify-center gap-4 text-center">
          ...
          <div className="w-full max-w-sm">
            <button
              type="button"
              onClick={() => {
                if (dashboardUpcomingSchedules.length === 0 && !portalAnalytics?.hasAssignment) {
                  toast.error("No active schedule assigned for today.");
                }
              ...
              {[
                {
                  ...
                  value: (typeof portalAnalytics.assignedCollege === "object" ? portalAnalytics.assignedCollege?.name : portalAnalytics.assignedCollege) || "—",
                },
