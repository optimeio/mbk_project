                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {filteredCourses.map((course) => {
                            ...
                            return (
                                ...
                                >
                                    {/* Icon / Image Banner */}
                                    <div className="h-36 bg-gradient-to-br from-indigo-50/50 to-sky-50/30 flex items-center justify-center relative border-b border-slate-50 overflow-hidden">
                                        {imageUrl ? (
                                            <img
                                                loading="lazy"
                                                src={imageUrl}
