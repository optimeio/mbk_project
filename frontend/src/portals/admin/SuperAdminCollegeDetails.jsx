...
const SuperAdminCollegeDetails = () => {
    const { id: routeId, departmentName: routeDepartmentName } = useParams();
    const id = useMemo(() => {
    ...
    // Extract the real department name from the URL when the static shell returns '1'
    const departmentName = useMemo(() => {
        const raw = Array.isArray(routeDepartmentName) ? routeDepartmentName[0] : routeDepartmentName;
    ...
    const selectedDepartment = decodeURIComponent(departmentName || 'General');
