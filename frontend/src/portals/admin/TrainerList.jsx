...
const EditTrainerModal = dynamic(() => import("@/components/modals/EditTrainerModal"), {
  loading: () => null,
  ssr: false,
});
...
const TrainerList = () => {
  ...
  const handleEditTrainerClick = useCallback((trainer, e) => {
  ...
  const renderManagementButtons = useCallback((row) => {
    ...
    return (
      <>
        ...
        <button
          type="button"
          onClick={(event) => handleEditTrainerClick(row, event)}
          className="rounded-xl border border-indigo-100 bg-indigo-50 p-2.5 text-indigo-600 transition hover:scale-105"
          title="Edit Trainer"
        >
